...
In this talk: *Ideas and tools* to\dots
...
- `Does not know about time and space': just an expression
...
*** TODO Array languages and Numpy

APL

/Perhaps a surprise:/ There's an APL hiding in Numpy
